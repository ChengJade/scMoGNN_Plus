...
def graph_construction(train_mod1, train_mod2, test_mod1, pretrain_path, bidirect = True):
    # Pathway Features
    mod1 = train_mod1.var['feature_types'][0]
    mod2 = train_mod2.var['feature_types'][0]
    input_train_mod1 = train_mod1.X[1000:]
    ...
    print("here_batch", batch_features.shape)
