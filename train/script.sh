...
## VIASH START
root_path="/home/chengyu/Pycharm/Predict_Modality"
meta_resources_dir="$root_path/DANCE/train"
#meta_functionality_name="submission_171129"

par_data_dir="$root_path/output/datasets/predict_modality"
#echo par_data_dir
...
par_output_pretrain="$root_path/DANCE/pretrain/output_pretrain/"
#echo par_output_pretrain

## VIASH END

#/home/chengyu/Pycharm/Predict_Modality/DANCE/output/pretrain/
...
#echo "Generating extra files1"
#echo "$meta_resources_dir/generate_extra_files.py"
...
#python "$meta_resources_dir/main.py" 'bf_alpha_conv4_mean_fullbatch_8000_phase2_inductive_gex2atac_2' \
#    -pww 'cos' -res 'res_cat' -inres -pwagg 'alpha' -pwalpha=0.5 -bs=60000 -nm 'group' -ac 'gelu' \
...
#python "$meta_resources_dir/main.py" 'bf_alpha_conv4_mean_fullbatch_8000_phase2_inductive_gex2atac_3' \
#    -pww 'cos' -res 'res_cat' -inres -pwagg 'alpha' -pwalpha=0.5 -bs=60000 -nm 'group' -ac 'gelu' \
#    -em=2 -ro=1 -conv=4 -agg 'mean' -sf -lr=1e-2 -wd=1e-5 -hid=48 -edd=0.4 -mdd=0.2 -e=10000 -sb -i 'normal' \
#    -t 'openproblems_bmmc_multiome_phase2_rna' \
#    -m "$par_output_pretrain" -r "$par_output_pretrain" -l "$par_output_pretrain" -d "$par_data_dir" -ef "$par_output_pretrain"
...
#python "$meta_resources_dir/main.py" 'bf_alpha_conv4_mean_fullbatch_10000_phase2_inductive_gex2atac' \
#    -pww 'cos' -res 'res_cat' -inres -pwagg 'alpha' -pwalpha=0.5 -bs=60000 -nm 'group' -ac 'gelu' \
#    -em=2 -ro=1 -conv=4 -agg 'mean' -sf -lr=1e-2 -wd=1e-5 -hid=48 -edd=0.4 -mdd=0.2 -e=10000 -sb -i 'normal' \
#    -t 'openproblems_bmmc_multiome_phase2_rna' \
#    -m "$par_output_pretrain" -r "$par_output_pretrain" -l "$par_output_pretrain" -d "$par_data_dir" -ef "$par_output_pretrain"
